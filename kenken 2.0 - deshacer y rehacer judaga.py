...
class Jugar(tkinter.Tk):
    ...
    def __init__(self):
        ...
        self.buttonDeshacer = Button(self, text = "Deshacer", width = 10, activebackground = "#4285f4",command = self.Deshacer, fg = "White", bg = "#4285f4", font = ("Comic Sans Ms", 15))
        self.buttonDeshacer.place(x = 955, y = 135)
        ...
        self.buttonRehacer.place(x = 955, y = 335)
