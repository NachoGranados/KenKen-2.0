...
class Jugar(tkinter.Tk):
    ...
    def Validar(self):
        ...
        # Dependiendo de la opcion marcada por el usuario, se ejecutara alguna de las funciones especificas.
        if T == 1:
    ...
    # Funcion para validar la cuadricula de 3x3.
    def V3x3(self):
    ...
    # Funcion para validar la cuadricula de 4x4.
    def V4x4(self):
    ...
    # Funcion para validar la cuadricula de 5x5.
    def V5x5(self):
    ...
    # Funcion para validar la cuadricula de 6x6.
    def V6x6(self):
    ...
    # Funcion para validar la cuadricula de 7x7.
    def V7x7(self):
    ...
    # Funcion para validar la cuadricula de 8x8.
    def V8x8(self):
    ...
    # Funcion para validar la cuadricula de 9x9.
    def V9x9(self):
